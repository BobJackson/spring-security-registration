package com.wangyousong.selfstudy.springsecurity.registration.web.error;


import com.wangyousong.selfstudy.springsecurity.registration.web.util.GenericResponse;
